  ...
  const renderProjectGrid = (projects) => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in">
      {projects.map((project) => (
        <div key={project.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
          {/* Video Preview */}
